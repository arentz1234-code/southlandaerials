...
const navigation = {
  ...
  company: [
    ...
    { name: "Become a Pilot", href: "/pilots" },
    { name: "Blog", href: "/golfcoastpilotblog" },
  ],
  contact: [
    { name: "Contact Us", href: "/contact" },
    { name: "Book Consultation", href: "/consultation" },
    { name: "Commercial Services", href: "/commercialpilotservices" },
  ],
};
...
const social = [
  {
    name: "Instagram",
    href: "https://instagram.com/southlandaerials",
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/southlandaerials",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
